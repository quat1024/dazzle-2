...
public class DazzleBlockEntityTypes {
	...
	public static final BlockEntityType<FlareBlockEntity> FLARE = BlockEntityType.Builder.create(FlareBlockEntity::new, DazzleBlocks.FLARES.values().toArray(new FlareBlock[0])).build(null);
